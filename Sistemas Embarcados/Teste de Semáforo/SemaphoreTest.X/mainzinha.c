 ...
 */
int cont, estado, flag_tela = 0, temp = 0;;
...
void main(void) {
    ...
    if(PORTDbits.RD0 == 1){//se o start for pressionado
        ...
        while(1){//iniciar test
            //contabilizar pontos
            if((PORTDbits.RD1 == 1)&&(LedRed == 1)){
               Delay10KTCYx (180);
               acertos++; 
            }else if((PORTDbits.RD2 == 1)&&(LedYellow == 1)){
               Delay10KTCYx (180);
               acertos++; 
            }else if((PORTDbits.RD3 == 1)&&(LedGreen == 1)){
               Delay10KTCYx (180);
               acertos++; 
            }else{
                Delay10KTCYx (180);
